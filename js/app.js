$(document).ready(function(){
    ...
    var typed = new Typed(".element",{
        strings: ["Pooja Dubey","a FullStack Web Developer","a Angular Developer"],
        smartBackspace:true,
        typeSpeed:100,
        backSpeed:100,
        loop:true,
    ...
    var waypoint = new Waypoint({
        ...
        handler: function() {
            ...
            p[7].setAttribute("style","width:70%;transition:4s all");
            p[8].setAttribute("style","width:72%;transition:3.3s all");
            p[9].setAttribute("style","width:65%;transition:3.7s all");
